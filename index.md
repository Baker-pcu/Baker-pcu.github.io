...
7. [게임 시스템 디자인](#게임-시스템-디자인)  
    ...
    7-2. [파라미터(속성) 뽑아 보기](#2-파라미터속성-뽑아-보기)  
    7-3. [행동 뽑아 보기](#3-행동-뽑아-보기)  
    7-4. [상태 뽑아 보기](#4-상태-뽑아-보기)  
...
|No|<c2>화면||용어|설명|  
|:-----:|:---:|:---|:---|:---:|  
|1|<r5>시작화면|<c3>베이킹 시뮬레이터를 실행하면 나오는 첫 화면이다. 타이틀, 새게임, 이어하기, 옵션버튼이 있다.|  
|2|<r4>화면 요소|타이틀|베이킹 시뮬레이터의 타이틀이다.|  
